...
SetGlobalStyle(padbottommargin=0.14, padleftmargin=0.15, padrightmargin=0.1, padtopmargin=0.05, titleoffsety=1.4, maxdigits=2, palette=53)
...
latSystem = LatLabel('Run 3 MC ', 0.6, 0.24, 0.04)
latSystem = LatLabel('pp, #sqrt{#it{s}} = 13.6 TeV', 0.6, 0.18, 0.04)
cBeta.Update()
